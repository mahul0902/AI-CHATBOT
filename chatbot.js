...
// API Setup
const API_KEY = "AIzaSyBbOhcTQZ-tYFACuMBPaDWgMaglf5_TIEY";
...
const handleFormSubmit = (e) => {
    ...
    class="img-attachment" />` : `<p class="file-attachment"><span class="materials-symbol-rounded">description</span>${userData.file.fileName}</p>`) : ""}`;
...
document.addEventListener("click", ({ target }) => {
    ...
    && (target.id === "add-file-button" || target.id === "stop-response-button"));
